            ...
            <div className="max-w-lg">
              ...
              <div className="flex flex-wrap -m-2">
                <div className="w-full sm:w-auto p-2">
                  <Link
                    href="/register"
                    className="inline-block px-8 py-4 w-full text-center text-white font-bold bg-blue-600 hover:bg-blue-700 rounded-full transition duration-200"
                  >
                    Начать пользоваться
                  </Link>
                </div>
                <div className="w-full sm:w-auto p-2">
                  <Link
                    href="#calculator"
                    className="inline-block px-8 py-4 w-full text-center text-gray-900 font-bold bg-gray-100 hover:bg-gray-200 rounded-full transition duration-200"
                  >
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={idx} className="flex items-center p-4 bg-gray-50 rounded-2xl">
                      ...
                      <div className="ml-4">
                        <p className="text-sm font-bold text-gray-900">{item.from} → {item.to}</p>
